...
1) Install a software that will run the php code : we propose  XAMPP 
...
then click on "go" 
 ...
 4)click on "Databases" ( Bases de données )  then write inside the Database Name then click on "create"
...
7) Now we need to create the second table :
	a)click on the name of our database 
...
9)Everything is set up inside the database , now copy the folder  and go inside the installation folder of the software "Xamp" then the folder "www" then paste it there .

10)Now open any browser you want and write "http://localhost/Brainiacswebsite" and click enter to use it .
...
1)Run the software  "XAMPP"

2)open any browser you want and write "http://localhost/Brainiacswebsite" and click enter to use the website 
