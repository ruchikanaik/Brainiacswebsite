          ...
          <div class="row align-items-center">
            <div class="col-12">
              <div class="row justify-content-center align-items-center text-center">
                <div class="col-lg-6">
                  <h1 data-aos="fade-up" data-aos-delay="0" class="text-white">C++ - Course</h1>
          ...
          <div class="col-lg-4 pl-lg-5">
            <div class="mb-5 text-center border rounded course-instructor">
              ...
              <div class="mb-4 text-center">
                <img src="../../../images/harry.jpg" alt="Image" class="w-25 rounded-circle mb-4">
                <h3 class="h5 text-black mb-4">CodeWithHarry</h3>
                <p> SITE PERSONNEL : https://www.codewithharry.com/
                For everyone who wants to level up their #Coding and #Dev skills.</p>
              </div>
            </div>
          </div>
