          ...
          <div class="row align-items-center">
            <div class="col-12">
              <div class="row justify-content-center align-items-center text-center">
                <div class="col-lg-6">
                  <h1 data-aos="fade-up" data-aos-delay="0" class="text-white">Learn C++ Programming | Video Tutorial for Beginners</h1>
          ...
          <div class="col-lg-8 mb-5">
            ...
            <div class="mb-5">
              ...
              <p>In this beginners c++  video tutorials series, you will learn the cpp programming  language
                ...
                user Input using cin, Comments and then Arithmetic Increment and decrement Modulus and
                Short-Hand Ternary operators, conditional statements if and else and Looping using while for
                and do while, break, continue and switch statements.
                After that we move on to the topics like Arrays, strings, functions, variable scopes then
                pointers, Structures, unions and strings then dynamic memory allocation using new and delete
                operators and then recursive functions and function overloading.
                After the basics we move on to the c++ object oriented programming (OOPS) and learn about
                classes objects and methods,inheritance, polymorphism and virtual functions,private public
                and protected access specifiers and inheritance levels, operator overloading, file handling,
                using exceptions then string streams and then pre processor directives, generic functions /
                methods and classes, name spaces.
                If you complete all these video series, you will have a sound understanding of cpp basics and
                you can move to advanced programming.</p>
            </div>
