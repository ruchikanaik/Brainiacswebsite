...
<div class="java-container">
  <div class="card" >
      <img src="file5.jpg" class="card-img-top" alt="..." >
      <div class="card-body">
      ...
      <a href="language/french/description_lingoni.php" class="fa-regular fa-folder-open fa-xl"></a><br>
      <a href="language/french/language_french_lingoni.php" class="fa-solid fa-tv fa-xl"></a>
  </div>

  <div class="card" >
      <img src="file10.jpg" class="card-img-top" alt="..." >
      <div class="card-body">
      ...
      <a href="language/french/description_vincent.php" class="fa-regular fa-folder-open fa-xl"></a><br>
      <a href="language/french/language_french_vincent.php" class="fa-solid fa-tv fa-xl"></a>
  </div>
  <div class="card" >
