...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="intro-section single-cover" id="home-section">
      ...
      <div class="slide-1 text-white" style="background-image: url('../../../images/course8.jpg');" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-12">
              <div class="row justify-content-center align-items-center text-center">
                <div class="col-lg-6">
                  <h1 data-aos="fade-up" data-aos-delay="0" class="text-white">Arabic Language for Beginners</h1>
                  <p data-aos="fade-up" data-aos-delay="100" class="text-white">4 Lessons / 3 Week &bullet; 3000 students &bullet; <a href="#" class="text-white">2 comments</a></p>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-lg-8 mb-5">
            ...
            <div class="mb-5">
              ...
              <p>Beginners tutorial to learn the Arabic Language</p>
            </div>
            <div class="pt-5">
              <h3 class="mb-5"></h3>
