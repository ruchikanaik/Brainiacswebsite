...
<title>Brainiacs</title>
 ...
 <body>
  ...
  <?php
      ...
      if (isset($_GET['video'])){
        switch ($_GET['video']) {
          case '1':
            $lien="https://www.youtube.com/embed/WgWNQVdhE9A";
            $nom_vid="Lecture 1";
            break;
          case '2':
            $lien="https://www.youtube.com/embed/nDCCLomrhb4";
            $nom_vid="Lecture 2";
            break;
          case '3':
            $lien="https://www.youtube.com/embed/DZ0WD4t8puE";
            $nom_vid="Lecture 3";
            break;
          case '4':
            $lien="https://www.youtube.com/embed/SJg2clKFRZ8";
            $nom_vid="Lecture 4";
            break;
          case '5':
            $lien="https://www.youtube.com/embed/38kB2jTOyug";
            $nom_vid="Lecture 5";
            break;
          case '6':
            $lien="https://www.youtube.com/embed/-PU5moAO-_M";
            $nom_vid="Lecture 6";
            break;
          case '7':
            $lien="https://www.youtube.com/embed/4mWewYiQv1w";
            $nom_vid="Lecture 7";
            break;
          case '8':
            $lien="https://www.youtube.com/embed/wSyGs-tiz6Y";
            $nom_vid="Lecture 8";
            break;
          case '9':
            $lien="https://www.youtube.com/embed/pNR4i8bHYpo";
            $nom_vid="Lecture 9";
            break;
          case '10':
            $lien="https://www.youtube.com/embed/WUEaZ44GLV4";
            $nom_vid="Lecture 10";
            break;
          case '11':
            $lien="https://www.youtube.com/embed/0AZBOW9KqNU";
            $nom_vid="Lecture 11";
            break;
          case '12':
            $lien="https://www.youtube.com/embed/OpmMQv6clwQ";
            $nom_vid="Lecture 12";
            break;
          case '13':
            $lien="https://www.youtube.com/embed/ZMc4BDtHOzI";
            $nom_vid="Lecture 13";
            break;
          case '14':
            $lien="https://www.youtube.com/embed/TAm7gMR_C-4";
            $nom_vid="Lecture 14";
            break;
          case '15':
            $lien="https://www.youtube.com/embed/jgWsZb60z74";
            $nom_vid="Lecture 15";
            break;
          case '16':
            $lien="https://www.youtube.com/embed/cuRhLSs6EPE";
            $nom_vid="Lecture 16";
            break;
          case '17':
            $lien="https://www.youtube.com/embed/kTt9G86K4ME";
            $nom_vid="Lecture 17";
            break;
          case '18':
            $lien="https://www.youtube.com/embed/co2ahTDWXig";
            $nom_vid="Lecture 18";
            break;
          case '19':
            $lien="https://www.youtube.com/embed/E8I4IDb2xwE";
            $nom_vid="Lecture 19";
            break;
          case '20':
            $lien="https://www.youtube.com/embed/xmY4cXb9leQ";
            $nom_vid="Lecture 20";
            break;
          default:
            # code...
 ...
 <nav aria-label="breadcrumb">
  <ol class="breadcrumb" style="background:linear-gradient(to right,rgba(242, 120, 159, 1),rgba(98, 205, 255, 1))">
    ...
    <li class="breadcrumb-item active" aria-current="page"><a href="engineering_chemical_lund.php" style="color:white;">Introduction to Chemical Engineering</a></li>
