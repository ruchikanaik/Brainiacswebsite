...
<title>Brainiacs</title>
 ...
 <nav aria-label="breadcrumb">
  <ol class="breadcrumb" style="background:linear-gradient(to right,rgba(242, 120, 159, 1),rgba(98, 205, 255, 1))">
    ...
    <li class="breadcrumb-item active" aria-current="page" style="color:white;">Introduction to Chemical Engineering</li>

  </ol>
</nav>
<!-- the actual content of this course ( Introduction to Chemical Engineering )
     liste des chapitres-->
