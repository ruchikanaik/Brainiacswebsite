...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="intro-section single-cover" id="home-section">
      ...
      <div class="slide-1 text-white" style="background-image: url('../../../images/course16.jpg');" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-12">
              <div class="row justify-content-center align-items-center text-center">
                <div class="col-lg-6">
                  <h1 data-aos="fade-up" data-aos-delay="0" class="text-white">Computer Science and Software Engineering Theory with Briana</h1>
        ...
        <div class="row">
          <div class="col-lg-8 mb-5">
            ...
            <div class="mb-5">
              ...
              <p>Get to know computer science and software engineering theory .</p>
            </div>
          ...
          <div class="col-lg-4 pl-lg-5">
            <div class="mb-5 text-center border rounded course-instructor">
              ...
              <div class="mb-4 text-center">
                <img src="../../../images/freecodecamp.jpg" alt="Image" class="w-25 rounded-circle mb-4">
                <h3 class="h5 text-black mb-4">freeCodeCamp</h3>
                  <p>We're an open source community of busy people who learn to code and build projects for
                    nonprofits.</p>
              </div>
            </div>
          </div>
