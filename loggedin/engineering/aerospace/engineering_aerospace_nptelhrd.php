...
<title>Brainiacs</title>
 ...
 <nav aria-label="breadcrumb">
  <ol class="breadcrumb" style="background:linear-gradient(to right,rgba(242, 120, 159, 1),rgba(98, 205, 255, 1))">
    ...
    <li class="breadcrumb-item active" aria-current="page" style="color:white;">Aerospace-Introduction to Helicopter Aerodynamics & Dynamics</li>

  </ol>
</nav>
<!-- the actual content of this course ( Aerospace-Introduction to Helicopter Aerodynamics & Dynamics )
     liste des chapitres-->
